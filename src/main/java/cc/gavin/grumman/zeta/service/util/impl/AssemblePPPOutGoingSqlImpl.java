 ...
 */
public class AssemblePPPOutGoingSqlImpl implements AssembleSql{

    private XSSFSheet xssfSheet;

    public AssemblePPPOutGoingSqlImpl(XSSFSheet xssfSheet){
    ...
    public List<String> getSqlList() {
        ...
        for (int rowNum = 1; rowNum <= xssfSheet.getLastRowNum(); rowNum++) {
            ...
            if (xssfRow != null) {
                String sql = "insert into `ppp_outgoing_info` ( `docket_time`, `docket_type`,  `docket_code`, " +
