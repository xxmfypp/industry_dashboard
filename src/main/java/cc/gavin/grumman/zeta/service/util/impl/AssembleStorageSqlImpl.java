 ...
 */
public class AssembleStorageSqlImpl implements AssembleSql{

    private XSSFSheet xssfSheet;

    public AssembleStorageSqlImpl(XSSFSheet xssfSheet){
    ...
    public List<String> getSqlList() {
        ...
        for (int rowNum = 1; rowNum <= xssfSheet.getLastRowNum(); rowNum++) {
            ...
            if (xssfRow != null) {
                String sql = "insert into `storage_info` ( `docket_time`, `docket_type`,  `docket_code`, " +
