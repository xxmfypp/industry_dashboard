...
<header class="header vertical-middle container-fluid">
    <a class="dsib icon" href="javascript:;">
    ...
    <div class="header-main justify">
        <div class="dsib top-nav vertical-middle js-top-nav">
            ...
            <c:if test="${sessionScope.customerInfo.role=='ADMIN'||sessionScope.customerInfo.role=='VIEW'}">
            ...
            <c:if test="${sessionScope.customerInfo.role=='ADMIN'||sessionScope.customerInfo.role=='UPLOAD'}">
